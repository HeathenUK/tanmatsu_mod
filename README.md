...
Uses libxmp to play any of the common tracker format (.mod, .s3m, .xm, .it) or libvgm to play any of the most common register-based sound chips logged to .vgm (or .vgz).
